...
router.get('/perfil', verifyToken, (req, res) => {
  ...
  const { nombre_usuario, tipo_usuario, foto_usuario,_id} = req.user;
  console.log({ nombre_usuario, tipo_usuario, foto_usuario, _id }); 
  res.json({ nombre_usuario, tipo_usuario, foto_usuario,_id});
});
